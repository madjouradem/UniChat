            ...
            Flexible(
              child: Container(
                margin: EdgeInsets.only(
                    bottom: 8.spMin,
                    left: controller.messagesList[index].mesSenderId !=
                            controller.myServices.box.read('user')['user_id']
                        ? 8.spMin
                        : 100.spMin,
                    right: controller.messagesList[index].mesSenderId !=
                            controller.myServices.box.read('user')['user_id']
                        ? 100.spMin
                        : 8.spMin,
                    top: 8.spMin),
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.only(
                    ...
                    topRight: controller.messagesList[index].mesSenderId !=
                            controller.myServices.box.read('user')['user_id']
                        ? Radius.circular(20.r)
                        : Radius.circular(0.r),
                    topLeft: controller.messagesList[index].mesSenderId !=
                            controller.myServices.box.read('user')['user_id']
                        ? Radius.circular(0.r)
                        : Radius.circular(20.r),
                  ),
                  // color: controller.messagesList[index].mesSenderId !=
                  //         controller.myServices.box.read('user')['user_id']
                  //     ? AppColor.primaryC1
                  //     : AppColor.primaryC1WithOpacity2,
                ),
                child: SelectableText('${decodeString(message.mesContent!)}',
